...
- **Claude review fixes (unreleased; Codex, 2026-09-15).** File ▸ Print now uses
  ...
  app was not replaced during validation. These fixes are prepared for 1.8.0.

- **Matching PDF document icon (unreleased; Codex, 2026-09-15).** Added
